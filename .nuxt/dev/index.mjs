...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///home/surge/projects/slang/slang_frontend/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/surge/projects/slang/slang_frontend/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import { renderSSRHead } from 'file:///home/surge/projects/slang/slang_frontend/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///home/surge/projects/slang/slang_frontend/node_modules/ofetch/dist/node.mjs';
...
import { version, unref } from 'file:///home/surge/projects/slang/slang_frontend/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///home/surge/projects/slang/slang_frontend/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/surge/projects/slang/slang_frontend/node_modules/@unhead/shared/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/surge/projects/slang/slang_frontend/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const getClientManifest = () => import('file:///home/surge/projects/slang/slang_frontend/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///home/surge/projects/slang/slang_frontend/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
